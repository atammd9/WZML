...
if len(TGH_THUMB) == 0:
    TGH_THUMB = 'https://github.com/fluidicon.png'
...
Image.open(photo_dir).convert("RGB").save('Thumbnails/thumb.jpg', "JPEG")
osremove(photo_dir)
...
if len(START_BTN2_NAME) == 0 or len(START_BTN2_URL) == 0:
    START_BTN2_NAME = 'Github Dev'
    START_BTN2_URL = 'https://github.dev'
...
if len(GD_INFO) == 0:
    GD_INFO = 'Uploaded by Mirror Leech bot'
